...
https://raw.githubusercontent.com/gravitee-io/release/master/upgrades/1.23.0/mongodb/1-set-groups-invitation-mode.js[upgrades/1.23.0/mongodb/1-set-groups-invitation-mode.js]::
