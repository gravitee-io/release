...
Int the new portal, 'views' are called 'categories'. But in the management console, they are still called 'views'.
...
https://raw.githubusercontent.com/gravitee-io/release/master/upgrades/3.x/3.0.2/mongodb/1-rename-view-in-category.js[upgrades/3.x/3.0.2/mongodb/1-rename-view-in-category.js]::
